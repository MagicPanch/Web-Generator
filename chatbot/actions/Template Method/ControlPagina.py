...
class BaseAction(Action, ABC):
    ...
    @abstractmethod
    def specific_run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        pass
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        if not tuto:
            dispatcher.utter_message(
                text="Para realizar esta acción primero debes completar el tutorial. ¿Deseas hacerlo ahora?")
